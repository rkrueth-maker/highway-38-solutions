...
public final class MainActivity extends Activity {
    ...
    private static final String PENNY_QTY_UI_PATCH =
            ...
            "var h38HammerLoopFixed='HAMMER_MUTATION_LOOP_FIXED_V1',list=document.getElementById('storeList'),obs=list?new MutationObserver(function(){decorate(list);Array.from(list.querySelectorAll('details[data-store-key][open]')).forEach(queuePenny);}):null;" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " H38ResellerScoutAndroid/0.1.15-hammer-fix");
    ...
    private final class ResellerBridge {
        ...
        @JavascriptInterface public String build() { return "20260819-multi-retailer-hd-penny-hammer-v015"; }
    }
}
