...
const deeperProducts = [
  ...
  },
  {
    ...
    summary: "A scoped custom build for useful work that does not fit a standard ForgeIQ product card.",
    ...
    steps: [["Review", "Look at the mess and decide if it fits ForgeIQ."], ["Scope", "Define the smallest useful custom output."], ["Quote", "Give a price, phase, and delivery format."], ["Build", "Deliver the custom file, page, tracker, packet, or system."]],
