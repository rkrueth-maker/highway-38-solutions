(function(){
'use strict';
const BUILD='20260824-assistant-command-input-1';
...
new MutationObserver(()=>{if(document.getElementById('paChat'))render();}).observe(document.documentElement,{childList:true,subtree:true});
window.H38_ASSISTANT_COMMAND_INPUT=Object.freeze({enabled:true,build:BUILD,run,routedChat:true,specialistDispatch:true});
})();
