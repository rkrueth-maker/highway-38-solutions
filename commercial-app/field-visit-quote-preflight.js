(function(){
'use strict';
const BUILD='20260807-0540';
function boot(){
 const C=window.H38_FIELD_VISIT_CORE;
 if(!C){setTimeout(boot,500);return;}
 if(window.H38_FIELD_VISIT_QUOTE_PREFLIGHT)return;
