...
function enhanceCustomer360(){
  ...
  grid.prepend(hero);grid.after(cards);hero.querySelectorAll('[data-h38-customer-action]').forEach(button=>button.onclick=()=>route(button.dataset.h38CustomerAction,cid));
}
