...
function clearSignedOutPolish(){
  ['h38CustomerReadyToday','h38CustomerReadyHero','h38CustomerReadyVisitSummary','h38NewActionButton','h38QuickCreateDialog'].forEach(id=>document.getElementById(id)?.remove());
}
