...
const TASK_STATES=Object.freeze(['Accepted','On My Way','Arrived','Started','Paused','Waiting','Blocked','Completed']);
...
async function reportIssue({jobId,taskId='',category='Other',note=''}={}){
  if(!isStaff())throw new Error('Staff sign-in is required.');
  const result=await rpc('business_office_employee_report_issue',{
