(function(){
'use strict';
const BUILD='20260917-office-account-identity-mobile-stable-1';
...
@media(max-width:760px){.business-bar{min-height:30px!important;max-height:30px!important;height:30px!important;display:flex!important;align-items:center!important;overflow:hidden!important;flex-wrap:nowrap!important}.business-bar>span#businessStatus{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}#${WRAP_ID}{width:auto;max-width:44%;margin-left:auto;flex:0 1 auto;overflow:hidden;flex-wrap:nowrap}.h38-office-account-badge{max-width:100%;padding:2px 7px;border:0;background:transparent;font-size:.68rem;white-space:nowrap;overflow:hidden}.h38-office-account-badge strong{display:none}.h38-office-account-value{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.h38-office-switch-account{display:none!important}}
`;
...
window.H38_OFFICE_ACCOUNT_IDENTITY=Object.freeze({build:BUILD,renderIdentity,switchAccount,mobileSingleLineIdentity:true,mobileStableBusinessBarHeight:true,permissionEscalation:false,automaticApproval:false,automaticSending:false,automaticPurchase:false,automaticPayment:false});
})();