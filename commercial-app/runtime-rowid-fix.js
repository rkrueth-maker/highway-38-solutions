...
const OWNER_MOBILE_QUICK_ACTIONS_BUILD='20260926-shared-tool-labels-6';
...
window.H38_RUNTIME_ROWID_FIX=Object.freeze({
  enabled:true,
  build:'20260926-shared-tool-labels-bootstrap-2',
  purpose:'Expose the record-id helper, load shared Clock In / Out under + and tenant-neutral shared tool labels for both H38 and Northern, owner phone recovery, notes-only Quick Meeting, install and phone-first shell support, keep Site Visit on one clean conversation/capture/finish flow, and lazy-load customer/document runtime only when those Office pages need it.',
  productionVerification:'20260926-shared-tool-labels-bootstrap-2',
