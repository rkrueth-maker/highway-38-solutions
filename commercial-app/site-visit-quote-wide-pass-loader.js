(function(){
'use strict';
const BUILD='20260821-site-visit-quote-wide-pass-loader-4';
const ASSET_BUILD='20260821-1051';
...
window.H38_SITE_VISIT_QUOTE_WIDE_PASS_LOADER=Object.freeze({enabled:true,build:BUILD,assetBuild:ASSET_BUILD,scripts:scripts.map(([path,build,global])=>({path,build,global})),legacyLoadsFirst:true,finalAuthoritiesLoadSequentially:true,siteVisitIdentityAuthority:true,linkedQuoteIdentityWriteFence:true});
void boot();
})();