(function(){
'use strict';
const BUILD='20260916-native-office-site-visit-mobile-simple-v2-1';
...
function loadMobileSimplificationV2(){if(window.H38_SITE_VISIT_MOBILE_SIMPLIFICATION_V2)return false;return loadScript('script[data-h38-site-visit-mobile-simplification-v2]','./site-visit-mobile-simplification-v2.js','data-h38-site-visit-mobile-simplification-v2');}
loadSiteVisitFinishPersistence();loadFinalPhoneRepair();loadMobileSimplificationV2();
window.H38_NATIVE_OFFICE_LAUNCH=Object.freeze({enabled:true,build:BUILD,officeDefault:true,siteVisitRequiresExplicitAction:true,nativeScannerAvailable:true,siteVisitFinishPersistenceLoaded:true,siteVisitFinalPhoneRepairLoaded:true,siteVisitMobileSimplificationV2Loaded:true});
})();