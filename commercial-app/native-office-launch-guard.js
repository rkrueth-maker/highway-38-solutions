(function(){
'use strict';
const BUILD='20260916-native-office-site-visit-mobile-simple-2';
...
function loadMobileSimplification(){if(window.H38_SITE_VISIT_MOBILE_SIMPLIFICATION)return false;return loadScript('script[data-h38-site-visit-mobile-simplification]','./site-visit-mobile-simplification.js?build=20260916-site-visit-mobile-simplification-2','data-h38-site-visit-mobile-simplification');}
loadSiteVisitFinishPersistence();loadFinalPhoneRepair();loadMobileSimplification();
