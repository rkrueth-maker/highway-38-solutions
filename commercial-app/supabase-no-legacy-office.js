(function () {
  ...
  function loadLifecycleAssistant() {
    ...
    if (!window.H38_JOB_LIFECYCLE && !document.querySelector('script[data-h38-job-lifecycle]')) {
      ...
      script.src = './job-lifecycle.js?build=20260919-search-scope-polish-1';
  ...
  function loadOfficePolish() {
    if (!document.querySelector('link[data-h38-office-polish]')) {
      const link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = './office-polish.css?build=20260919-business-office-visual-polish-2';
  ...
  function loadSiteVisitController() {
    ...
    const script = document.createElement('script');
    script.src = './field-visit-guided-controller.js?build=20260811-guided-ar-advance-1';
