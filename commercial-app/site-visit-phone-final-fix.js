...
(function(){
'use strict';
const BUILD='20260922-site-visit-linked-customer-authority-2';
const C=window.H38_FIELD_VISIT_CORE;
if(!C)return;
...
install();
window.H38_SITE_VISIT_QUOTE_OPTIONAL={build:BUILD,ensureDraftQuoteForVisit,quoteOptionalUntilExplicitFinish:true,placeholderQuoteCreationStopped:true,existingQuotePreserved:true,existingVisitCustomerWinsBlankForm:true,explicitFinishCreatesQuote:true,sessionCanSaveWithoutQuote:true,mutationChurnGuarded:true,automaticApproval:false,automaticCustomerSending:false,automaticPurchasing:false,automaticPayment:false};
})();
