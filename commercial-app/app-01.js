...
async function init(){
  ...
  const settings=await get('meta','settings')||{id:'settings',bridgeUrl:BRIDGE_URL,drivingMode:false};state.drivingMode=!!settings.drivingMode;state.businessId=(await get('meta','selectedBusiness'))?.businessId||'';
