(function(){
'use strict';
const BUILD='20260809-0427';
const REVISION='20260809-0427';
...
window.H38_ANDROID_CAMERA_DIRECT_FIX={build:BUILD,revision:REVISION,restoredCombinedCameraMicRequest:true,immediatePermissionRequest:true,singleWalkthroughLaunch:true,cameraRequired:true,microphoneRequired:true,videoOnlyFallback:false,inlineDraftDeleteConfirm:true,inlineQuoteDeleteConfirm:true};
})();
