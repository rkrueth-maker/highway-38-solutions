const CACHE_NAME='h38-business-office-20260807-1345';
const FIELD_RECOVERY_BUILD='20260807-1345';
const SUPABASE_CDN='https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2';
const LIVE_FIRST=new Set(['index.html','manifest.webmanifest','runtime-rowid-fix.js','supabase-config.js','supabase-single-client.js','supabase-session-recovery.js','supabase-startup.js','supabase-final-startup.js','supabase-quote-ai.js','supabase-quote-ai-auth-fix.js','quote-mobile-stabilization.js','quote-ai-live-fix.js','quote-working-hammer.js','quote-total-lock.js','quote-drift-control.js','quote-render-approval.js','quote-final-acceptance-fix.js','quote-final-phone-fix.js','quote-print-safe.js','print-safe.css','quote-photo-restore.js','supabase-quote-delivery.js','quote-pdf-send-live-fix.js','quote-delivery-final-fix.js','site-scanner.js','site-scanner.css','site-scanner-mobile-guidance.js','field-visit-core.js','field-visit-ui.js','field-visit.js','field-visit-video.js','field-visit-recovery.js','field-visit-measurement-fix.js','field-visit-photo-review.js','field-visit.css','field-visit-guidance.js','field-visit-guidance.css','auth-autofill.js','auth-autofill.css','app-15.js']);
const SHELL=[
  './','./index.html','./recover.html','./manifest.webmanifest',
  './styles.css','./ai-drawer.css','./quote-delivery.css','./print-safe.css','./site-scanner.css','./field-visit.css','./field-visit-guidance.css','./auth-autofill.css',
  ...
  './quote-ai-live-fix.js','./quote-working-hammer.js','./quote-total-lock.js','./quote-drift-control.js','./quote-render-approval.js','./quote-final-acceptance-fix.js','./quote-final-phone-fix.js','./quote-print-safe.js','./quote-photo-restore.js','./supabase-quote-delivery.js','./quote-pdf-send-live-fix.js','./quote-delivery-final-fix.js','./site-scanner.js','./site-scanner-mobile-guidance.js','./field-visit-core.js','./field-visit-ui.js','./field-visit.js','./field-visit-video.js','./field-visit-recovery.js','./field-visit-measurement-fix.js','./field-visit-photo-review.js','./field-visit-guidance.js','./auth-autofill.js','./supabase-no-legacy-office.js',
