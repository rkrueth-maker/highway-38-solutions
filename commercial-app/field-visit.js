(function(){
'use strict';
const BUILD='20260808-1805',C=window.H38_FIELD_VISIT_CORE;if(!C)return;const S=C.state,$=C.$;
...
function focusQuote(){
  ...
  if(!launch){
    ...
    launch.innerHTML=`<div><span class="field-kicker">FIELD-FIRST QUOTE</span><h2>Capture the job before building the quote</h2><p>Start with a video walkthrough, then add targeted photos, measurements and notes. Everything stays together online or offline.</p></div><button id="h38StartFieldVisit" class="field-primary">📍 Start Site Visit</button><details class="field-quote-more"><summary>More quote tools</summary><div id="h38QuoteOverflow" class="field-quote-overflow"></div></details>`;
...
function loadVideoWalkthrough(){
  ...
  const script=document.createElement('script');script.src='./field-visit-video.js?build=20260808-1805';script.dataset.h38FieldVideo='1';document.head.appendChild(script);
}
