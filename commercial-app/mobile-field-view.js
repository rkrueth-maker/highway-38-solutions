...
function renderMyDay(){
  ...
  host.querySelector('[data-h38-next-message]')?.addEventListener('click',()=>window.openPage?.('messages'));
...
function renderJobHub(){
  ...
  host.querySelector('[data-h38-job-message]')?.addEventListener('click',()=>window.openPage?.('messages'));
