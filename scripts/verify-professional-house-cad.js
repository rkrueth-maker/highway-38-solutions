...
['HVAC Plan on Coordinated Architectural Underlay','KITCHEN','LIVING','BATH / MECH','AHU-1','CU-1','EQUIPMENT / AIR DEVICE SCHEDULE','Every register, return, equipment item, thermostat, condenser, and duct route is tied to the coordinated room/wall plan','x="1075" y="671.0" width="30" height="60"','M1000.0 600.0 H1075 V701.0'].forEach(v=>need(m,v,'M-101 coordinated HVAC content and exterior service clearance'));
...
['Plumbing Plan on Coordinated Architectural Underlay','KITCHEN','MUD / LAUNDRY','BATH / MECH','WATER / SANITARY SERVICE ENTRY','DOMESTIC WATER / DWV RISER','FIXTURE SCHEDULE','Every plumbing fixture and service route is anchored','cx="1070" cy="740.0" r="7"','x="1060" y="728.0"','M1070 740.0 H930.0 V615.0'].forEach(v=>need(p101,v,'P-101 coordinated plumbing content and service-entry clearance'));
...
console.log(JSON.stringify({status:'PASS',revision:'F',scope:'ground-up-new-home',professionalCadSheets:10,format:'17x11 SVG',sharedTradeUnderlays:true,floatingObjectControls:true,tradeObjectClearances:true,lotClearingFirst:true,externalActions:0},null,2));
