...
['SOUTH / FRONT ELEVATION','NORTH / REAR ELEVATION','EAST / RIGHT ELEVATION','WEST / LEFT ELEVATION','24′-6″ RIDGE','18′-0″ EAVE','8:12','COVERED','CHIMNEY','ASPHALT SHINGLES / METAL DRIP EDGE','LAP SIDING + 5/4 TRIM','class="muntin"','class="roof"','class="wood"'].forEach(v=>need(a201,v,'A-201 enhanced elevation content'));
...
['BUILDING SECTION A-A — THROUGH PORCH / KITCHEN / STAIR','DETAIL 1 — EXTERIOR WALL / EAVE','DETAIL 2 — WINDOW OPENING / FLASHING','DETAIL 3 — DECK LEDGER / FLASHING','24′-6″','2×6 STUD','ENGINEERED FLOOR SYSTEM','CONTINUOUS METAL FLASHING','JOIST HANGER / LEDGER','class="insul"','class="earth"'].forEach(v=>need(a301,v,'A-301 enhanced section/detail content'));
