...
const checks={
 ...
 'phone safe zone':files.phone.includes('padding-bottom:calc(168px')&&files.phone.includes('@media(max-width:340px)'),
 'Smart Upload loaded':files.index.includes('smart-upload.js?build=20260919-final-95-smart-upload-1')&&files.index.includes('smart-upload.css?build=20260919-final-95-smart-upload-1'),
 'Smart Upload confirms ambiguity':files.upload.includes('requiresConfirmation')&&files.upload.includes('Confirm & save privately')&&files.upload.includes('retainsOriginal:true'),
