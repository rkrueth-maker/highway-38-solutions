...
for(const token of [
  ...
  'crossTenantRequest','engineAttack','productRequest','cancelPending','requestOwnerReview'
...
check('runtime is loaded in existing Office',index.includes('assistant-tenant-actions.js?build=20260922-tenant-aware-office-actions-1'));
