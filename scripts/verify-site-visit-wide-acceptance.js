...
assert(loader.includes("site-visit-quote-wide-pass-loader-6"),'wide pass loader build did not advance');
...
assert(hammer.includes('site-visit-quote-wide-pass-loader-6'),'quote working hammer can still load the stale wide-pass loader');
console.log('PASS site-visit-wide-acceptance Amanda replay + backend field authority');
