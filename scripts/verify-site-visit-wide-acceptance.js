...
assert(identity.includes('site-visit-work-dedupe-final-4-phone'),'physical-card identity authority did not advance');
...
assert(identity.includes('function cardForButton(button)'),'identity authority still depends on .row-only matching');
...
assert(loader.includes("site-visit-quote-wide-pass-loader-8-phone"),'wide pass loader build did not advance');
assert(loader.includes("site-visit-work-dedupe-final-4-phone"),'wide pass loader does not load physical-card identity authority');
...
assert(hammer.includes('site-visit-quote-wide-pass-loader-8-phone'),'quote working hammer can still load the stale wide-pass loader');
console.log('PASS site-visit-wide-acceptance Amanda replay + backend field authority + physical Jobs/Quote phone repair');
