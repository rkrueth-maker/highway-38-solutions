...
const noop=()=>{};
const document={documentElement:{},body:{classList:{add:noop,remove:noop}},getElementById:()=>null,querySelector:()=>null,addEventListener:noop,createElement:()=>({style:{},dataset:{},appendChild:noop,setAttribute:noop})};
...
assert(sw.includes("h38-business-office-20260821-1605"),'service worker cache rollover missing');
...
assert(loader.includes("site-visit-wide-acceptance-final.js"),'wide pass loader does not load the final authority');
console.log('PASS site-visit-wide-acceptance Amanda replay');
