...
for(const marker of ["applicationId 'com.highway38.sitescanner'",'targetSdk 35','versionCode 7',"versionName '0.5.2'"])must(gradle,marker,'Android release config');
...
for(const marker of ['https://highway38solutions.com/commercial-app/','H38SiteScannerAndroid/0.5.2','shouldResetRestoredUrl','onPageCommitVisible','buildLaunchCover','MediaStore.ACTION_VIDEO_CAPTURE','MediaStore.EXTRA_DURATION_LIMIT'])must(main,marker,'Android Business Office shell');
...
console.log('PASS — H38 Google Play internal release contract 0.5.2');
