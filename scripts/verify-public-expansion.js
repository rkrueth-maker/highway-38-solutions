...
const expected=['index.html','sample-library-now.html','solutions.html','software.html','project-services.html','pricing.html','quote-builder-demo.html','implementation.html','security-reliability.html','about.html','contact.html','start-request.html','portal.html'];
check('all current public gateways are canonical',expected.every(page=>primary.includes(page))&&primary.length===expected.length,JSON.stringify(primary));
