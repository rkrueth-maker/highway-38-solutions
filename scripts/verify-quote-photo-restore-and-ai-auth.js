...
requireText(worker, "h38-business-office-20260805-1800", 'Service worker cache rotation');
...
console.log('Quote photo restore and direct AI authentication verification passed.');
