...
for (const token of ["versionCode 15","versionName '0.5.10'","owner {","applicationIdSuffix '.test'",'androidx.credentials:credentials:1.6.0-beta02','androidx.camera:camera-camera2:1.5.3','androidx.camera:camera-video:1.5.3','androidx.camera:camera-view:1.5.3']) must(gradle, token, 'Android v0.5.10 config');
...
for (const token of ['nativeBridge','requestAutofill','Use saved username and password','h38:saved-login-filled','invitationPending','h38RecoveryForm','clearInvitationFlag']) must(authAutofill, token, 'Android auth and invitation activation');
