...
for (const token of ["versionCode 13","versionName '0.5.8'",'androidx.credentials:credentials:1.6.0-beta02','androidx.camera:camera-camera2:1.5.3','androidx.camera:camera-video:1.5.3','androidx.camera:camera-view:1.5.3']) must(gradle, token, 'Android v0.5.8 config');
