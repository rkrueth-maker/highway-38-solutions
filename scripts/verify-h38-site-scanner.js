...
for(const token of ['H38_FIELD_VISIT_FAST_FOLLOWUP','actualNotesOnCapture:true','nextPhotoImmediate:true','onePhotoAtATime:true','backgroundProcessing:true'])must(followup,token,'fast field follow-up');
...
for(const token of ['versionCode 26',"versionName '0.5.21'",'owner {',"applicationIdSuffix '.test'",'androidx.camera:camera-video:1.5.3'])must(gradle,token,'Android v0.5.21 config');
