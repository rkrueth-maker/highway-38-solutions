...
check(has(index,[
  ...
  'auth-session-guard.js','auth-cache-guard.js?build=20260825-auth-cache-guard-desktop-nav-clicks-4','supabase-startup.js?build=20260910-0100','authSignOutButton'
