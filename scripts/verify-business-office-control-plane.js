...
check('direct Business Office loads control and equipment clients',read('web').includes("boInclude_('BusinessOffice_ControlPlane_Client')")&&read('web').includes("boInclude_('BusinessOffice_Equipment_Client')"));
