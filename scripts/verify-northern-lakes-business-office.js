...
const aiClient=requireFile('BusinessOffice_QuoteBuilder_AI_Client.html');
const aiServer=requireFile('BusinessOffice_QuoteBuilder_AI.gs');
const required=[
  ...
  [index,/BusinessOffice_QuoteBuilder_AI_Client/,'AI client included'],
...
if(!process.exitCode)console.log(JSON.stringify({status:'PASS',installation:'Northern Lakes Business Office',businessId:'NLPS',isolated:true,quoteBuilder:'shared engine',cameraUploadSplit:true,aiDraft:true,completionVisual:true,ownerApprovalRequired:true},null,2));
