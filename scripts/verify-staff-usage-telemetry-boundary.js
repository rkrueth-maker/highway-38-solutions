...
(async()=>{
  ...
  assert(previousCalls===0,'Staff usage telemetry must be stopped before the generic business-record adapter.');
  ...
  assert(owner.staffUsageTelemetrySuppressed!==true,'Owner telemetry response must not claim Staff suppression.');
