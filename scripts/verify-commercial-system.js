...
check('homepage routes through neutral discovery',home.includes('href="start-request.html"')&&home.includes('href="solutions.html"')&&home.includes('href="pricing.html"')&&!/href=["'](?:quote-builder|business-systems|sample-library-now|universal-quote-builder)\.html/i.test(home));
...
const result={status:failures.length?'HOLD':'PASS',generatedAt:new Date().toISOString(),passed:passes.length,failed:failures.length,architecture:'project-first-equal-product-paths-with-embedded-public-quote-cad-packages',pricingProducts:3,existingProjectExamples:existingExampleCount,universalDemonstration:true,publicPlacement:'directly beneath whole-building house example',officeGeneratedDemo:true,publicMatchedPackages:packages.length,publicCadSheets:drawings.length,catalogCompatibilityOnly:true,passes,failures};
