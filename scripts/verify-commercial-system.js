...
check('Universal Quote Builder demonstrates an Office-generated result',universal.includes('One project inside Office.')&&universal.includes('Office-generated public demonstration')&&universal.includes('?publicUqbDemo=1'));
check('Universal demonstration shows complete quote and CAD evidence',universal.includes('14</strong>complete phase quotes')&&universal.includes('56</strong>itemized quote lines')&&universal.includes('10</strong>attached CAD sheets'));
check('Universal demonstration preserves safety boundary',universal.includes('Demonstration control:')&&universal.includes('automatic external actions')&&publicDemo.includes('externalActionsPerformed:false'));
check('Universal demonstration removes the renovation tangent',!universal.includes('Whole-House Renovation and Property Improvement')&&!universal.includes('$342,815'));
...
const result={status:failures.length?'HOLD':'PASS',generatedAt:new Date().toISOString(),passed:passes.length,failed:failures.length,architecture:'project-first-office-generated-public-demo',pricingProducts:3,existingProjectExamples:existingExampleCount,universalDemonstration:true,officeGeneratedDemo:true,catalogCompatibilityOnly:true,passes,failures};
