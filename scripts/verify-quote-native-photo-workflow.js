...
need(live,'gutter && gutter.rate > 0','nonzero gutter rate assertion');
need(live,'downspout && downspout.rate > 0','nonzero downspout rate assertion');
...
new Function(live);
console.log('PASS — native visible Android file controls, immediate single-request private uploads, actual photo analysis, Price Book pricing, saved-draft editing, Android return recovery, and live production acceptance are wired without programmatic picker clicks.');
