...
check('direct-link responses require trusted Apps Script origin',bridge.includes("host==='script.google.com'")&&bridge.includes("host.endsWith('.script.googleusercontent.com')")&&bridge.includes('trustedDirectWindow'));
...
const output={status:failures.length?'FAIL':'PASS',checks:27,failures,fastSignedInStartup:true,browserSafeSignIn:true,indexedDbCannotBlockSignIn:true,ownerOnlyBusinessSwitcher:true,officeBeforeFullRefresh:true,publicDomainAcceptance:true,browserPopupAcceptance:true,deployedWebAppAcceptance:true};
