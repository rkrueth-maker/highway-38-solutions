...
console.log('PASS native walkthrough auto-start + native same-video microphone derivative + automatic post-capture processing + visibly swinging hammer v0.5.27');
