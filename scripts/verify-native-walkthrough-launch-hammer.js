...
if(versionCode<39||versionName!=='0.5.34')throw new Error(`Android touch-safe watchdog candidate version is invalid: ${versionName} (${versionCode})`);
console.log(JSON.stringify({status:'PASS',nativeWalkthroughAuthority:'CameraX',guidedControllerAuthority:true,walkthroughArAdvanceLinked:true,maxWalkthroughSeconds:300,currentCandidateSource:versionName,androidStartupAssetsLiveFirst:true,earlyStartupCoverBounded:true,nativeRendererHangWatchdog:true,touchSafeWatchdog:true,startupOnlyRendererKill:true,physicalPhoneAcceptanceExternal:true,automaticApproval:false,automaticCustomerSending:false},null,2));
