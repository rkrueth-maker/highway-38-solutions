...
for(const s of ['loadSiteVisitController','H38_FIELD_VISIT_GUIDED_CONTROLLER','H38_FIELD_VISIT_GUIDANCE','./field-visit-guided-controller.js?build=20260811-guided-stable-1152'])must(noLegacy,s,'dynamic Site Visit authority');
...
console.log('PASS native walkthrough + same-video audio + stable unified Site Visit review + server draft recovery + verified-dimension dedupe/display + photo action/delete controls + server evidence cascade v0.5.27');