...
console.log(JSON.stringify({status:'PASS',nativeWalkthroughAuthority:'CameraX',guidedControllerAuthority:true,walkthroughArAdvanceLinked:true,currentCandidateSource:'0.5.28',acceptedOwnerApkBaseline:'0.5.27',physicalPhoneAcceptanceExternal:true,automaticApproval:false,automaticCustomerSending:false},null,2));