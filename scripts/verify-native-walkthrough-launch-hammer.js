...
for(const s of ['./field-visit-guided-controller.js?build=20260810-guided-controller-2058','./auth-autofill.js?build=20260810-owner-login-one-step-2040'])must(index,s,'production runtime');
...
console.log('PASS native walkthrough + same-video audio + unified persistent Site Visit review + visible inline hammer + follow-up queues + measurement candidates v0.5.27');
