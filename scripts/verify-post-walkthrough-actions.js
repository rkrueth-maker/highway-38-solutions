...
must(index,'operator-direct-controls.js?build=20260809-0245');
...
const directPos=index.indexOf('operator-direct-controls.js?build=20260809-0245');
const guidancePos=index.indexOf('field-visit-walkthrough-guidance.js?build=20260809-0048');
if(!(voicePos>0&&transcriptPos>voicePos&&directPos>transcriptPos&&guidancePos>directPos))throw new Error('walkthrough video-note runtime load order is wrong');
for(const s of ["CACHE_NAME='h38-business-office-20260809-0255'",'field-visit-voice-capture.js','field-visit-transcription.js','operator-direct-controls.js','field-visit-walkthrough-guidance.js'])must(sw,s);
