...
console.log(JSON.stringify({status:'PASS',siteVisitPrimary:'business-office-web',androidAuthority:'optional native CameraX companion',sameVideoAudioDerivative:true,oneGuidedController:true,walkthroughArAdvanceLinked:true,currentCandidateSource:versionName,currentCandidateVersionCode:versionCode,acceptedOwnerApkBaseline:'0.5.27',physicalPhoneAcceptanceExternal:true,automaticApproval:false,automaticCustomerSending:false},null,2));
