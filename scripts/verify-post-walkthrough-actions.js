...
for(const s of ["const BUILD='20260809-1110'",'nativeGetUserMedia','audio:true','#fieldWalkthrough','cameraFirstMicrophoneRecovery:true','separateSourceAcquisition:true','audioSourceRetry:true','immediatePermissionRequest:true','microphoneRequired:true','videoOnlyFallback:false'])must(cameraFix,s);
must(index,'android-camera-direct-fix.js?build=20260809-1110');
mustNot(index,'android-camera-direct-fix.js?build=20260809-0330');
...
const cameraPos=index.indexOf('android-camera-direct-fix.js?build=20260809-1110');
...
console.log(JSON.stringify({status:'PASS',oneWalkthroughVideo:true,speechFromSameRecording:true,microphoneRequired:true,videoOnlyFallback:false,androidPermissionFromTap:true,currentAndroidRecorderLoader:true,professionalNotes:true,rawTranscriptInternalOnly:true,automaticFieldSync:true,targetedNextNeed:true,separateDictationWorkflow:false,automaticApproval:false,automaticCustomerSending:false},null,2));
