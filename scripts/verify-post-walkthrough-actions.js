...
for(const s of ['H38_FIELD_VISIT_FAST_FOLLOWUP','actualNotesOnCapture:true','editableSavedNotes:true','nextPhotoImmediate:true','measurementVerificationFirst:true','plainVideoDepthGeometry:false','backgroundProcessing:true','workingHammer:true','visibleSwingHammer:true'])must(followup,s,'post-walkthrough follow-up');
...
for(const s of ['versionCode 32',"versionName '0.5.27'",'androidx.camera:camera-video:1.5.3'])must(gradle,s,'Android version');
...
console.log(JSON.stringify({status:'PASS',androidAuthority:'direct native CameraX bridge',iphoneAuthority:'native video input',sameVideoAudioDerivative:true,nativeSameVideoAudio:true,separateWebViewRecorder:false,durableNativeRecovery:true,visibleSwingHammer:true,editableSavedNotes:true,measurementVerificationFirst:true,plainVideoDepthGeometry:false,directQuoteDelete:true,directSiteVisitDelete:true,version:'0.5.27',automaticApproval:false,automaticCustomerSending:false},null,2));
