...
function boRenderWebApp_(){
  ...
  html=html.replace('Business Office',title)
    ...
    .replace('</body>',boInclude_('BusinessOffice_UX_Client')+boInclude_('BusinessOffice_QuoteBuilder_Client')+boInclude_('BusinessOffice_Unified_Client')+boInclude_('BusinessOffice_QuoteBuilder_Completion')+'</body>');
...
function boApi(request){
  ...
  const handlers={
    ...
    save:function(){return boQuoteBuilderSaveRecord_(args.module,args.recordId||'',args.values||{});},
    ...
    createQuote:function(){return boCreateQuoteFast_(args.payload||{});},
    reviseQuote:function(){return boQuoteBuilderReviseQuote_(args.quoteId,args.changes||{});},
    ...
    quoteBuilderQuoteDocuments:function(){return boQuoteBuilderQuoteDocuments_(args.quoteId);},
    quoteBuilderLastCreatedQuote:function(){return boQuoteBuilderLastCreatedQuote_();},
    saveQuotePhoto:function(){return boQuoteBuilderSaveCapturedPhoto_(args.payload||{});},
    ...
    approve:function(){return boQuoteBuilderApprove_(args.recordType,args.recordId,args.approvalType,args.decision,args.notes||'');},
    quoteToJob:function(){return boQuoteBuilderToJob_(args.quoteId);},
    ...
    uploadDocument:function(){return boQuoteBuilderUploadDocument_(args.payload||{});},
