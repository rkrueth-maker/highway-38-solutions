...
function boGetUnifiedModuleContract_(){
  ...
  var modules=[
    ...
    boUnifiedModule_('settings','Settings','office','native','settings','settings','⚙','preferences configuration',{secondary:true,essential:true,disablePolicy:'required'}),
    ...
    boUnifiedModule_('quoteBuilder','Quote Builder','work','capability','','quotes','▱','camera quote visual proposal',{visible:false,dependencies:['quotes','customers','documents'],dataOwner:'BusinessOffice',serverOwner:'apps-script/business-office',clientOwner:'BusinessOffice_QuoteBuilder_Client.html'}),
