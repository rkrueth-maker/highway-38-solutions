...
function boGetUnifiedModuleContract_(){
  ...
  var modules=[
    ...
    boUnifiedModule_('customers','Customers','sales','business','bo:customers','customers','◎','contacts clients accounts',{essential:true,disablePolicy:'required',definition:{title:'Customers',primaryKey:'Customer ID',fields:['Customer Number','Display Name','Customer Type','Email','Alternate Email','Phone','Mobile Phone','Alternate Phone','Preferred Contact Method','Service Address','Service Address 2','Service City','Service State','Service ZIP','Billing Address','Billing Address 2','Billing City','Billing State','Billing ZIP','Hourly Rate','Flat Rate','Recurring Service Rate','Mowing Rate','Plowing Rate','Property Maintenance Rate','Minimum Charge','Equipment Rate','Travel / Service Call Charge','Contract Pricing','Payment Terms','Tax Status','Tags','Status','Attention Status','Notes']}}),
