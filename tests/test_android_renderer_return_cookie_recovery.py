...
def test_renderer_restart_rehydrates_existing_pr750_keys_before_return_repair():
...
def test_cookie_is_written_only_after_exact_visit_and_session_identity_exist():
    ...
    assert "if(!value.visitId||!value.sessionId)return null" in remember
