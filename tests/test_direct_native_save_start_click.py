...
def test_top_action_delegates_return_and_does_not_own_restore_or_launch():
    ...
    repair = TOP.split("async function repairNativeReturn", 1)[1].split("function start", 1)[0]
