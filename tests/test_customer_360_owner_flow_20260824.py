...
def test_customer_is_primary_operational_hub_and_internal_finance_is_excluded():
    assert "const BUILD='20260922-customer-workspace-layout-authority-4'" in C360
...
def test_customer_360_dynamic_loader_uses_latest_physical_runtime_filename():
    ...
    assert 'customer-360-authority.js?build=20260922-customer-workspace-layout-authority-4' in BROWSER
