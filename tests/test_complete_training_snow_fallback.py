...
def test_legacy_complete_training_wrapper_repairs_only_exact_snow_fixture_gap():
...
def test_legacy_snow_fallback_is_real_runtime_training_and_does_not_mutate_business_data():
...
def test_video_workflow_requires_strict_complete_training_wrapper():
    ...
    assert 'node scripts/run-complete-training-library-final.js' not in workflow
